...
<hr />
 ...
 <section id="container">
  ...
  <input type="hidden" id="page" value="${scri.page}" readonly="readonly">
  <input type="hidden" id="perPageNum" value="${scri.perPageNum}" readonly="readonly">
  <input type="hidden" id="searchType" value="${scri.searchType}" readonly="readonly">
  <input type="hidden" id="keyword" value="${scri.keyword}" readonly="readonly">
